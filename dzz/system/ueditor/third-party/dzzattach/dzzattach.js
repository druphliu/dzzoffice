...
dzzattach.thumb=function(id){
	...
	jQuery(dzzattach.root).find('.dzz-image').each(function(index){
	 ...
	 var preview_setupDom=function(){
		...
		var html='';
		html+='<div id="preview_Container" class="modal"  style="position:absolute;width:100%;height:100%;top:0px;left:0px;bottom:0px;right:0px;display:none;z-index:10000">';
