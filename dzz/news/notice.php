...
if($list){
	 ...
	 $html.=  '<tr><td><a href="'.DZZSCRIPT.'?mod=news&op=view&newid='.$value['newid'].'" onclick="OpenApp(\''.$appid.'\',this.href);return false" style="font-size:14px;line-height:30px;">'.$value['subject'].'</a><small style="color:#999"> by '.$value['author'].'</small></td></tr>';
	 }
	 $html.=' </table>';
	 $html.=' </div>';
	 $html.='</div>';
